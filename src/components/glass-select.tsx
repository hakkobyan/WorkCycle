...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:outline-none focus:border-white/16 focus:bg-white/[0.04]",
      "focus:ring-2 focus:ring-white/8 focus:ring-offset-0",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-white/10 bg-[#1a1a1f]",
        "text-white",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-sm font-semibold text-white/45", className)}
    {...props}
  />
))
